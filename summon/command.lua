...
- Fade       Lerp on alpha.
  ...
  --[[Idle]]---------------------------------------------------------------------
  local IdleCommand = loader.class("IdleCommand", Command)
  ...
  Command.idle = IdleCommand

  --[[Delay]]---------------------------------------------------------------------
  local DelayCommand = loader.class("DelayCommand", Command)
  ...
  --[[Turn]]---------------------------------------------------------------------
  local TurnCommand = loader.class("TurnCommand", Command)
  ...
  --[[LookAt]]--------------------------------------------------------------------
  local LookAtCommand = loader.class("LookAtCommand", Command)
  ...
  Command.lookAt = LookAtCommand

  --[[Animation]]----------------------------------------------------------------
  local AnimationCommand = loader.class("AnimationCommand", Command)
  ...
  --[[Wait]]---------------------------------------------------------------------
  local WaitCommand = loader.class("WaitCommand", Command)
  ...
  --[[Speak]]--------------------------------------------------------------------
  local SpeakCommand = loader.class("SpeakCommand", Command)
  ...
  Command.speak = SpeakCommand

  --[[Translate]]----------------------------------------------------------------

  local TranslateCommand = loader.class("TranslateCommand", Command)
  ...
  local WalkCommand = loader.class("WalkCommand", Command)
  ...
  local JumpCommand = loader.class("JumpCommand", Command)
  ...
  Command.jump = JumpCommand

  --[[Step]]---------------------------------------------------------------------

  local StepCommand = loader.class("StepCommand", Command)
  ...
  --[[FadeOut]]----------------------------------------------------------------
  local FadeCommand = loader.class("FadeCommand", Command)
